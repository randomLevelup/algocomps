...
Main script for ParkerGPT. Also contains the splice_melody function
...
def splice_melody(model_f, model_b, device,
    ...
    """
    Splices a melody with segments generated by forward and backward models.
    """
    ...
    take = 'melody' # start by taking from the original melody
    ...
    while pos < melody.duration.quarterLength * 24:
        if take == 'melody':
            if pos_i > len_split:
                ...
                # generate tokens with the forward and backward models
                ...
                # reset indices and things to "take from model" mode
                pos_i = pos
                pos_j = pos + len_split
                out_fwd = []
                out_back = []
            ...
            if pos_j - pos_i < crossover_threshold:
                ...
                # switch to "take from melody" mode
                pos_i = 0
                pos += len_split
                take = 'melody'
                continue
                
            # take next elements from models
...
def main(args):
    """
    Main function to run ParkerGPT in training or inference mode.
    """
